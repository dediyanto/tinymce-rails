function select_image(element){
	element = $(element);
    element.closest('ul').children('li:first').removeClass("selected");
...
function ts_onload(){
	$('#dynamic_images_list').replaceWith("<div id='dynamic_images_list'>Uploading...<br /><img src='img/spinner.gif'></div>");
